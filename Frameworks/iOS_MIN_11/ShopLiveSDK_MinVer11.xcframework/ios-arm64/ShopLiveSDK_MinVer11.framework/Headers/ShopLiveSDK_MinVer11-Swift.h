...
#ifndef SHOPLIVESDK_MINVER11_SWIFT_H
#define SHOPLIVESDK_MINVER11_SWIFT_H
...
SWIFT_PROTOCOL("_TtP20ShopLiveSDK_MinVer1119ShopLiveSDKDelegate_")
@protocol ShopLiveSDKDelegate
...
SWIFT_CLASS("_TtC20ShopLiveSDK_MinVer1112ShopLiveUser")
...
@interface ShopLiveUser (SWIFT_EXTENSION(ShopLiveSDK_MinVer11))
@end
...
@interface UIViewController (SWIFT_EXTENSION(ShopLiveSDK_MinVer11))
