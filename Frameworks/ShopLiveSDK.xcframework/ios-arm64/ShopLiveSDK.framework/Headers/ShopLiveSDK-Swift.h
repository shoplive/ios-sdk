...
@class NSString;
SWIFT_ENUM_FWD_DECL(NSInteger, ResultStatus)
SWIFT_ENUM_FWD_DECL(NSInteger, ResultAlertType)
...
SWIFT_ENUM_FWD_DECL(NSInteger, ShopLiveViewHiddenActionType)
@class UIFont;
...
SWIFT_ENUM_FWD_DECL(NSInteger, ShopLiveResizeMode)
@interface ShopLive (SWIFT_EXTENSION(ShopLiveSDK))
...
SWIFT_ENUM_FWD_DECL(NSInteger, ShopLiveResultStatus)
SWIFT_ENUM_FWD_DECL(NSInteger, ShopLiveResultAlertType)
...
SWIFT_ENUM_FWD_DECL(NSInteger, ShopLivePlayerCampaignStatus)
