...
dependencies: [
//player
.package(url: "https://github.com/shoplive/ios-sdk.git", .upToNextMajor(from: "1.8.8"))
.package(url: "https://github.com/shoplive/common-ios", .upToNextMajor(from: "1.8.8"))
]
```
