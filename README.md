...
#livePlayerSDK
pod 'ShopLive', '1.8.7.2'
pod 'ShopliveSDKCommon' , '1.8.7.2'
end
```
...
dependencies: [
//player
.package(url: "https://github.com/shoplive/ios-sdk.git", .upToNextMajor(from: "1.8.7.2"))
.package(url: "https://github.com/shoplive/common-ios", .upToNextMajor(from: "1.8.7.2"))
]
```
